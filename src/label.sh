...
python benchmark.py --gold=../external_datasets/mesquita_2013/processed/web.oie.correct.head \
    --out=/dev/null --tabbed=${eval_dir}/web.txt --predArgHeadMatchExclude --label=${eval_dir}/web.txt.label --label_format=raw &&
...
python benchmark.py --gold=../external_datasets/mesquita_2013/processed/penn.oie.correct.head \
    --out=/dev/null --tabbed=${eval_dir}/penn.txt --predArgHeadMatchExclude --label=${eval_dir}/penn.txt.label --label_format=raw &&
popd
